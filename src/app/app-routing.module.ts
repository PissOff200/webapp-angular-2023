...
const app_routes: Routes = [
  ...
  { path: 'terminos', component: TerminosComponent }, //"localhost:4200/terminos"
  { path: 'project', component: ProyectosComponent },//"localhost:4200/project"
  { path: 'meloinvento', redirectTo: 'terminos' },
